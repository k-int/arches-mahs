"""
Django settings for mahs project.
"""
...
DATATYPE_LOCATIONS.append('mahs.datatypes')
FUNCTION_LOCATIONS.append('mahs.functions')
ETL_MODULE_LOCATIONS.append('mahs.etl_modules')
SEARCH_COMPONENT_LOCATIONS.append('mahs.search_components')
...
SECRET_KEY = 'django-insecure-%%3i$v8z*o2vvmd$o+pbn_y$e3&0nfn=!@$wd6f&^*x!f_g&4t'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = "mahs.urls"
ROOT_HOSTCONF = "mahs.hosts"
...
ELASTICSEARCH_PREFIX = 'mahs'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'mahs.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'mahs.wsgi.application'
